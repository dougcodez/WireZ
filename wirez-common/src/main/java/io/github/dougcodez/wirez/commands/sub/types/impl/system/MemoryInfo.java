...
public class MemoryInfo extends SubCommand {
    ...
    public String getSubCommandDescription() {
        return Lang.MEMORY_INFO_DESC.toConfigString();
    }

    @Override
    public String getSubCommandSyntax() {
        return Lang.MEMORY_INFO_SYN.toConfigString();
    }
    ...
    public void perform(Object sender, String[] args, WireZSettingsFile file) {
        ...
        user.sendMessage(prefix + Lang.MEMORY_INFO_HEADER.toConfigString());
        SystemMonitorCommands.sendDiskInformation(user);
        SystemMonitorCommands.sendRamInformation(user);
    }
}
